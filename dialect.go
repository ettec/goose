...
type SQLDialect interface {
	...
	dbVersionQuery(db db) (*sql.Rows, error)
}
...
func (pg PostgresDialect) dbVersionQuery(db db) (*sql.Rows, error) {
...
func (m MySQLDialect) dbVersionQuery(db db) (*sql.Rows, error) {
	rows, err := db.Query(fmt.Sprintf("SELECT version_id, is_applied from %s ORDER BY id DESC", TableName()))
	if err != nil {
		return nil, err
	}
...
func (m SqlServerDialect) dbVersionQuery(db db) (*sql.Rows, error) {
	rows, err := db.Query(fmt.Sprintf("SELECT version_id, is_applied FROM %s ORDER BY id DESC", TableName()))
	if err != nil {
		return nil, err
	}
...
func (m Sqlite3Dialect) dbVersionQuery(db db) (*sql.Rows, error) {
	rows, err := db.Query(fmt.Sprintf("SELECT version_id, is_applied from %s ORDER BY id DESC", TableName()))
	if err != nil {
		return nil, err
	}
...
func (rs RedshiftDialect) dbVersionQuery(db db) (*sql.Rows, error) {
	rows, err := db.Query(fmt.Sprintf("SELECT version_id, is_applied from %s ORDER BY id DESC", TableName()))
	if err != nil {
		return nil, err
	}
...
func (m TiDBDialect) dbVersionQuery(db db) (*sql.Rows, error) {
	rows, err := db.Query(fmt.Sprintf("SELECT version_id, is_applied from %s ORDER BY id DESC", TableName()))
	if err != nil {
		return nil, err
	}
...
func (m ClickHouseDialect) dbVersionQuery(db db) (*sql.Rows, error) {
